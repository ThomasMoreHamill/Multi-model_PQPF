SUBROUTINE calculate_terrain_gradients(nxa, nya, earth_radius_meters, &
...
REAL, INTENT(OUT), DIMENSION (nxa,nya) :: terrain_gradx, terrain_grady
...
END DO ! jya
RETURN
END SUBROUTINE calculate_terrain_gradients